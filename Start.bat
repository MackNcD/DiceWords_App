...
call :printCentered "Invalid choice. Please enter a valid number (1, 2, 3, 4, 5, or 6)."
pause
goto menu
...
if not exist Dicewords.py (
    call :printCentered "The Python script 'Dicewords.py' does not exist."
    pause
    goto menu
)
