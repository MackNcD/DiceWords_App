...
from customtkinter import CTkEntry, CTkSlider, CTkTextbox, CTkButton, CTkSegmentedButton, CTkSwitch, CTkLabel
...
titleImg = PhotoImage(file='assets/imgs/title.png')
titleLabel = ttk.Label(text=None, image=titleImg, background='black')
titleLabel.place(y=0, x=230) #x=390 for old title
...
rand_genre_slider = CTkSlider(app, from_=0, to=10, 
                            ...
                            bg_color='black',
                            button_color=diceword_menu_bg, fg_color=button_color,
...
realism_slider = CTkSlider(app, from_=0, to=100, 
                            ...
                            bg_color='black',
                            button_color=diceword_menu_bg, fg_color=bg,
                            progress_color=button_color,
                            button_hover_color=faded_text_B)
...
for i, (short_name, var) in enumerate(genres1):
    ...
    checkbutton = CTkSwitch(app, bg_color='black',
                            button_color=diceword_menu_bg, fg_color=button_color,
                            progress_color='#0e0e0e',
                            button_hover_color=faded_text_B,
